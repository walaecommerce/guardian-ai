      ...
      <section id="features" className="py-20 md:py-28 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map(f => (
              <Card key={f.title} className="bg-white/[0.03] border-white/5 backdrop-blur-2xl hover:border-primary/20 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <Card key={i} className="bg-white/[0.03] border-white/5 backdrop-blur-2xl">
      ...
      <section id="pricing" className="py-20 md:py-28 px-6 bg-card/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TIERS.map(tier => (
              <Card key={tier.slug} className={`bg-white/[0.03] backdrop-blur-2xl transition-colors ${tier.highlight ? 'border-primary/40 ring-1 ring-primary/20' : 'border-white/5'}`}>
                <CardContent className="p-6 space-y-4">
                  {tier.badge && (
